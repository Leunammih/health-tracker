...
- Use the "tracks" list for anything the user wants trended over time that is NOT a hard-exercise-with-soreness bout: meditation and breath work and other practices (value = minutes; set "time" to the time of day if mentioned, e.g. "7am meditation" -> "07:00"; put any named method/technique/teacher in notes, e.g. "Joe Dispenza", "9D breathwork", "box breathing"); ongoing pain or discomfort like stomach pain, knee/joint pain, shoulder pain, wrist pain, back pain, muscle soreness, or muscle stiffness (category "symptom", value = 0-10 severity, NOT minutes); brain/mental clarity (category "other", value = 0-10, high = clearer, NOT minutes); body measurements like weight (value + unit kg/lb); and lighter or named activities such as kite surfing, dancing, stretching, swimming, biking, walking (value = minutes if given). Give each a short lowercase name so repeated mentions group together (e.g. always "meditation", "breath work", "knee pain", "stomach pain", "muscle soreness", "muscle stiffness", "brain clarity", "weight"). Keep hard workouts where post-exercise soreness matters (runs, strength, long hikes) in "activities", not "tracks". A one-off stomach ache mentioned outside a full gut episode still belongs in "tracks" as a "stomach pain" entry (not gut_events) so it shows up alongside other pain trends — reserve gut_events for episodes with bloating, stool consistency, or a warming-bottle need.
- Do NOT add supplements, vitamins, pills, or enzymes (e.g. "took digestive enzymes", "magnesium before bed") to "tracks" — those are a yes/no regimen tracked separately in the app's own Supplements feature, not a daily value. If the user mentions taking one, leave it out of the structured output entirely; don't ask a follow-up question about it either.
