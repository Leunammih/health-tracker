...
import { wellbeingSince, gutSince, infectionsSince, mealsSince, dayContextSince } from '../db/queries'
...
export default function InsightsTab() {
  ...
  const { wb, gut, inf, meals, ctx } = useMemo(
    () => ({
  ...
  const hasAny = wb.length || gut.length || inf.length || meals.length
